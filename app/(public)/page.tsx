...
export default async function HomePage() {
  ...
  const socials = (p?.socials ?? {}) as Record<string, string | undefined>
  ...
  return (
    <div className='relative overflow-hidden'>
      ...
      <div className='fixed inset-0 -z-10 overflow-hidden pointer-events-none'>
        ...
        <div
          className='absolute bottom-10 right-10 w-96 h-96 bg-purple-400/10 rounded-full blur-3xl animate-pulse'
                ...
                <div className='flex items-center gap-4'>
                  <div className='h-20 w-20 rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900'>
                    {p?.avatar_url ? (
                      ...
                      <div className='h-full w-full grid place-items-center text-2xl'>
                        👤
                      </div>
                    )}
                  </div>
                  <div>
                    ...
                    <p className='text-base md:text-lg font-bold bg-clip-text text-transparent bg-linear-to-r from-blue-600 via-purple-600 to-pink-600'>
                      {p?.headline ||
                        'Junior Software Developer • Carpenter / Fabricator'}
                    </p>
                ...
                <div className='min-w-65 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/40 p-4'>
                  ...
                  <div className='space-y-2 text-sm text-zinc-700 dark:text-zinc-300'>
                    ...
                    <div className='flex flex-wrap gap-2 pt-2'>
                      ...
                      {p?.cv_url ? (
                        <a
                          className='text-xs font-black text-zinc-900 dark:text-white hover:underline'
                          href={p.cv_url}
                          target='_blank'
                          rel='noreferrer'
                        >
              ...
              <div className='md:col-span-4 p-6 md:p-8 border-b md:border-b-0 md:border-r border-zinc-200 dark:border-zinc-800 bg-white/60 dark:bg-zinc-950/30'>
                ...
                <div className='mb-8'>
                  ...
                  <div className='space-y-3'>
                      ...
                      <div key={s.id}>
                        ...
                        <div className='h-2 rounded-full bg-zinc-200 dark:bg-zinc-800 overflow-hidden'>
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, Math.max(0, (s.level / 5) * 100))}%`,
                            }}
                          />
                        </div>
                      </div>
                    ...
                    <Link
                      href='/skills'
                      className='inline-block mt-3 text-sm font-black text-blue-600 dark:text-blue-400 hover:underline'
                    >
                      View all skills →
                    </Link>
                  </div>
                ...
                <div className='mb-8'>
                  ...
                  <div className='space-y-3'>
                    {(education as Education[] | null)?.map((e) => (
                      <div
                        key={e.id}
                        className='rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 bg-white dark:bg-zinc-950/30'
                      >
                        ...
                        <p className='text-xs text-zinc-500 dark:text-zinc-400 mt-1'>
                          ...
                          {formatMonthYear(e.end_date) || 'Present'}
                  ...
                  <div className='space-y-3'>
                    {(certificates as Certificate[] | null)?.map((c) => (
                      ...
                      >
                        ...
                        {c.url ? (
                          <a
                            className='inline-block mt-2 text-sm font-black text-blue-600 dark:text-blue-400 hover:underline'
                            href={c.url}
                            target='_blank'
                            rel='noreferrer'
                          >
                        ...
                        <div className='rounded-2xl border border-zinc-200 dark:border-zinc-800 p-5 bg-white dark:bg-zinc-950/30'>
                          <div className='flex flex-col md:flex-row md:items-start md:justify-between gap-2'>
                            ...
                            <div className='text-sm text-zinc-500 dark:text-zinc-400 md:text-right'>
                              ...
                              {exp.is_current
                                ? 'Present'
                                : formatMonthYear(exp.end_date) || 'Present'}
                            </div>
                          </div>
                ...
                {projects?.length ? (
                  <div>
                    <div className='flex items-end justify-between gap-4 mb-4'>
                      <SectionTitle
                        title='Projects'
                        subtitle='Live links + GitHub + media'
                      />
                      <Link
                        href='/projects'
                          ...
                          return (
                            ...
                            >
                              {cover?.url ? (
                                ...
                                <div className='aspect-video bg-zinc-100 dark:bg-zinc-900 grid place-items-center text-3xl'>
                                  🧩
                                </div>
                              )}
