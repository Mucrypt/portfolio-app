        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl mb-8 text-white/90 leading-relaxed">
              Expert web development, mobile apps, consulting, and training services
              to bring your vision to life with cutting-edge technology and world-class expertise.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 bg-linear-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Our most sought-after services trusted by startups and enterprises
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Enterprise-grade security and 99.9% uptime guarantee for all projects',
              },
              {
                icon: '📈',
              ...
              },
              {
                ...
                description: 'Comprehensive post-launch support and maintenance packages available',
              },
            ].map((benefit, index) => (
              <div
                key={index}
