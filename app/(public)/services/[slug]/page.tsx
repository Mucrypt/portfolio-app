...
export default async function ServiceDetailPage({
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                ...
                <div className="text-2xl font-bold">
                  ${pricingTiers[0]?.price?.toLocaleString() || service.base_price.toLocaleString()}
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="text-sm text-white/70 mb-1">Duration</div>
                <div className="text-2xl font-bold">{service.estimated_duration}</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                <div className="text-sm text-white/70 mb-1">Service Type</div>
                <div className="text-2xl font-bold capitalize">{service.service_type}</div>
              </div>
            </div>
              ...
              {service.consultation_required && (
                <div className="bg-linear-to-br from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200">
                  ...
                  <p className="text-gray-700 text-sm mb-4">
                    We require a {service.consultation_duration}-minute consultation to understand
            ...
            <div className="text-center mb-12">
              ...
              {service.is_price_negotiable && (
                <p className="text-sm text-blue-600 mt-2">
                  💡 Custom pricing available - Let&apos;s discuss your specific requirements
                </p>
              )}
            </div>
              ...
              <ul className="space-y-3">
                {service.deliverables?.map((item: string, index: number) => (
                  <li key={index} className="flex items-start text-gray-700">
                    <span className="mr-3 text-green-500 shrink-0 text-xl">✓</span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="space-y-8">
              ...
              {service.excluded_services && service.excluded_services.length > 0 && (
                <div>
                  ...
                  <ul className="space-y-2">
                    {service.excluded_services.map((item: string, index: number) => (
                      <li key={index} className="flex items-start text-gray-700 text-sm">
      ...
      {/* Inquiry Form */}
      <section id="inquiry-form" className="py-20 bg-linear-to-b from-slate-50 to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
