...
export default async function CourseDetailPage({
  ...
  const { data: relatedCourses } = await supabase
    .from('courses')
    .select(
      'id, title, slug, thumbnail_url, instructor_name, platform, discounted_price, original_price, currency, level, rating',
    )
  ...
  const discountPercentage =
    typedCourse.original_price && typedCourse.discounted_price
      ? Math.round(
          ((typedCourse.original_price - typedCourse.discounted_price) /
      ...
      <div className='max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24'>
        ...
        <div className='grid lg:grid-cols-3 gap-12'>
          ...
          <div className='lg:col-span-2'>
            ...
            {/* What You'll Learn */}
            {typedCourse.what_you_learn &&
              typedCourse.what_you_learn.length > 0 && (
            ...
            {/* Requirements */}
            {typedCourse.requirements &&
              typedCourse.requirements.length > 0 && (
                <div className='mb-8'>
                  <h2 className='text-2xl font-black text-zinc-900 dark:text-white mb-4'>
                    Requirements
                  </h2>
                  ...
                  <div className='space-y-3 pt-6 border-t border-zinc-200 dark:border-zinc-800'>
                    ...
                    {typedCourse.duration_hours && (
                      <div className='flex items-center gap-3 text-sm text-zinc-700 dark:text-zinc-300'>
                        <span className='text-purple-600'>🎥</span>
                        <span>
                          {typedCourse.duration_hours} hours on-demand video
                        </span>
                      </div>
                    )}
                    <div className='flex items-center gap-3 text-sm text-zinc-700 dark:text-zinc-300'>
                  ...
                  <div className='p-5'>
                    ...
                    <div className='flex items-center justify-between'>
                      <span className='text-xl font-black text-zinc-900 dark:text-white'>
                        {formatPrice(
                          related.discounted_price || related.original_price,
                          related.currency,
                        )}
                      </span>
