      ...
      <div className="mb-12">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <p className="text-lg leading-relaxed mb-4">
            Each project in this portfolio represents a <strong>real, working solution</strong> — not just a demo.
          </p>
          ...
          <ul className="space-y-3 text-zinc-700 dark:text-zinc-300 mb-8">
            <li>
              <strong>Title & Description</strong> — A clear explanation of the problem and how the solution works.
            </li>
            <li>
              <strong>Tech Stack</strong> — Displayed as visual chips (e.g. React, React Native, TypeScript, Node.js, Supabase).
            </li>
            <li>
              <strong>Live Links</strong> — Live website, GitHub repository, Play Store / App Store, demo videos.
            </li>
            <li>
              <strong>Gallery Images</strong> — Screenshots showing web UI, mobile UI, dashboards, and admin panels.
            </li>
          </ul>
          <p className="text-base text-zinc-600 dark:text-zinc-400 border-l-4 border-blue-500 pl-4 italic">
            Visitors can click into each project to explore the functionality, view the interface, 
            and navigate directly to the live product. This structure allows recruiters and clients 
            to verify your skills immediately, without guessing.
          </p>
        </div>
      </div>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              {project.project_media?.[0]?.url && (
                <div className="aspect-video bg-zinc-100 dark:bg-zinc-700 overflow-hidden">
                  <img
              ...
              <div className="p-6">
                ...
                {project.project_links && project.project_links.length > 0 && (
                  <div className="flex flex-wrap gap-2 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                    {project.project_links.map((link: any) => (
                      <a
                        key={link.id}
                        href={link.url}
                        target="_blank"
