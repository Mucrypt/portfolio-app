...
const faqs = [
  {
    ...
    answer: "I typically respond to messages within 24 hours during business days. For urgent matters, feel free to call."
  },
  {
  ...
  },
  {
    ...
    answer: "My rates vary depending on project scope and complexity. Let's discuss your specific needs, and I'll provide a detailed quote."
  },
  {
    question: "Do you offer maintenance packages?",
    answer: "Yes, I offer ongoing maintenance and support packages for all projects. This includes updates, bug fixes, and feature enhancements."
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
            Have a project in mind? Whether it's a new build, consultation, or just a chat about tech — I'd love to hear from you.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white/90 dark:bg-zinc-950/70 backdrop-blur-sm p-12 text-center">
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-8 max-w-2xl mx-auto">
              From initial concept to final deployment, I'll help bring your vision to life with clean code and solid architecture.
            </p>
