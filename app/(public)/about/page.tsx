...
export default async function AboutPage() {
  ...
  const [{ data: timeline }, { data: sections }, { data: highlights }, { data: quotes }, { data: softwareSkills }] =
    await Promise.all([
      ownerId
        ? supabase
            .from("about_timeline")
        ...
        : Promise.resolve({ data: [] as AboutTimelineRow[] } as any),
      ...
      ownerId
        ...
        : Promise.resolve({ data: [] as AboutSectionRow[] } as any),
      ...
      ownerId
        ...
        : Promise.resolve({ data: [] as AboutHighlightRow[] } as any),
      ...
      ownerId
        ...
        : Promise.resolve({ data: [] as AboutQuoteRow[] } as any),
      ...
      ownerId
        ? supabase
            ...
            .limit(12)
            .returns<SkillRow[]>()
        : Promise.resolve({ data: [] as SkillRow[] } as any),
    ]);
