        ...
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <p className='text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed'>
              Premium templates, components, tools, and curated products to
              supercharge your development workflow. Save weeks of development
              time!
            </p>
          ...
          <div className='container mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-gray-600 text-lg'>
                Handpicked premium products you&apos;ll love
              </p>
            </div>
        ...
        <section className='py-16 px-4 sm:px-6 lg:px-8'>
          <div className='container mx-auto'>
            {Object.entries(productsByCategory).map(
              ([category, products]: [string, ShopProduct[]]) => (
          ...
          <div className='relative overflow-hidden rounded-3xl bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 p-12 md:p-16 text-center text-white'>
            ...
            <div className='relative z-10 max-w-3xl mx-auto'>
              ...
              <p className='text-xl mb-8 text-white/90'>
                Can&apos;t find what you&apos;re looking for? I create custom
                templates, components, and tools tailored to your specific
                needs.
              </p>
