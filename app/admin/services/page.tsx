...
export default function AdminServicesPage() {
  ...
  const handleDuplicate = async (service: Service) => {
    ...
    const duplicate = {
      ...
      slug: `${service.slug}-copy-${timestamp}`,
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField(
                        'subcategories',
                        parseCommaArray(e.target.value),
                      )
                    }
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
            ...
            {activeTab === 'pricing' && (
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  ></textarea>
                  <p className='text-xs text-gray-500 mt-1'>
                    Format: [&#123;"name": "Tier Name", "price": 5000,
                    "features": ["Feature 1"]&#125;]
                  </p>
                </div>
              ...
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField('key_features', parseArray(e.target.value))
                    }
                    rows={6}
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField('deliverables', parseArray(e.target.value))
                    }
                    rows={6}
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField('requirements', parseArray(e.target.value))
                    }
                    rows={4}
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField('typical_results', parseArray(e.target.value))
                    }
                    rows={4}
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateField('tools', parseCommaArray(e.target.value))
                      }
                      className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
              ...
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField('case_study_urls', parseArray(e.target.value))
                    }
                    rows={4}
                    className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500'
