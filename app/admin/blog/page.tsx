...
export default function AdminBlogPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const postData = {
      ...
      publish_date: formData.publish_date || (formData.is_published ? new Date().toISOString() : null),
    };
  ...
  function handleEdit(post: BlogPost) {
    ...
    setFormData({
      ...
      meta_keywords: Array.isArray(post.meta_keywords) ? post.meta_keywords : [],
  ...
  async function togglePublish(post: BlogPost) {
    const { error } = await supabase
      ...
      .update({ 
        ...
        publish_date: !post.is_published ? new Date().toISOString() : post.publish_date
      })
      .eq("id", post.id);
  ...
  function getFilteredPosts() {
    ...
    if (filterStatus === "published") {
      filtered = filtered.filter(p => p.is_published && (!p.publish_date || new Date(p.publish_date) <= new Date()));
  ...
  const stats = {
    total: posts.length,
    published: posts.filter(p => p.is_published && (!p.publish_date || new Date(p.publish_date) <= new Date())).length,
    draft: posts.filter(p => !p.is_published).length,
    scheduled: posts.filter(p => p.is_published && p.publish_date && new Date(p.publish_date) > new Date()).length,
  };
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className={`px-2 py-1 rounded text-xs font-bold ${
                            post.is_published && (!post.publish_date || new Date(post.publish_date) <= new Date())
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-5xl my-8">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Content * ({formData.content_format === "markdown" ? "Markdown" : "HTML"})
                  </label>
                  <div className="flex gap-2 mb-2">
                    <button
                      type="button"
                      onClick={() => setFormData(prev => ({ ...prev, content_format: "markdown" }))}
                    ...
                    <button
                      type="button"
                      onClick={() => setFormData(prev => ({ ...prev, content_format: "html" }))}
                      className={`px-3 py-1 rounded text-sm ${
              ...
              <div className="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, featured_video_url: e.target.value }))}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <textarea
                      value={Array.isArray(formData.video_urls) ? formData.video_urls.join("\n") : ""}
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, reading_time_minutes: parseInt(e.target.value) }))}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                      min="1"
                    />
                  </div>
              ...
              {/* SEO */}
              <div className="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-6">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">SEO Optimization</h3>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, code_language: e.target.value }))}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, series_order: e.target.value ? parseInt(e.target.value) : null }))}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                      placeholder="1"
                      min="1"
                    />
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, publish_date: e.target.value ? new Date(e.target.value).toISOString() : null }))}
                      className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, allow_likes: e.target.checked }))}
