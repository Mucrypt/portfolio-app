...
export default function AdminAboutPage() {
  const [activeTab, setActiveTab] = useState<
    'page' | 'sections' | 'timeline' | 'highlights' | 'quotes'
  >('page')
  ...
  const [editingHighlight, setEditingHighlight] =
    useState<AboutHighlight | null>(null)
  ...
  async function saveAboutPage() {
    ...
    const { error } = aboutPage
      ...
      : await supabase
          .from('about_page')
          .insert({ ...pageForm, owner_user_id: user.id })
  ...
  async function saveSection() {
    ...
    const { error } = editingSection
      ...
      : await supabase
          .from('about_sections')
          .insert({ ...sectionForm, owner_user_id: user.id })
  ...
  async function saveTimeline() {
    ...
    const { error } = editingTimeline
      ...
      : await supabase
          .from('about_timeline')
          .insert({ ...timelineForm, owner_user_id: user.id })
  ...
  async function saveHighlight() {
    ...
    const { error } = editingHighlight
      ...
      : await supabase
          .from('about_highlights')
          .insert({ ...highlightForm, owner_user_id: user.id })
  ...
  async function saveQuote() {
    ...
    const { error } = editingQuote
      ...
      : await supabase
          .from('about_quotes')
          .insert({ ...quoteForm, owner_user_id: user.id })
        ...
        <div className='space-y-4'>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                setPageForm({ ...pageForm, mission: e.target.value })
              }
              className='w-full px-4 py-2 border rounded dark:bg-zinc-800'
              rows={2}
            />
          ...
          <div className='grid md:grid-cols-2 gap-4'>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPageForm({
                    ...pageForm,
                    cta_primary_label: e.target.value,
                  })
                }
                className='w-full px-4 py-2 border rounded dark:bg-zinc-800'
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPageForm({ ...pageForm, cta_primary_href: e.target.value })
                }
                className='w-full px-4 py-2 border rounded dark:bg-zinc-800'
              />
            </div>
        ...
        <div>
          <div className='mb-6 p-4 border rounded dark:bg-zinc-800'>
            <h3 className='text-xl font-bold mb-4'>
              {editingTimeline ? 'Edit Timeline' : 'Add Timeline Item'}
            </h3>
            <div className='space-y-3'>
              <div className='grid md:grid-cols-2 gap-4'>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTimelineForm({ ...timelineForm, city: e.target.value })
                    }
                    className='w-full px-4 py-2 border rounded dark:bg-zinc-700'
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTimelineForm({ ...timelineForm, period: e.target.value })
                  }
                  className='w-full px-4 py-2 border rounded dark:bg-zinc-700'
              ...
              <div className='grid md:grid-cols-3 gap-4'>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setTimelineForm({ ...timelineForm, icon: e.target.value })
                    }
                    className='w-full px-4 py-2 border rounded dark:bg-zinc-700'
                    placeholder='🇨🇲'
                  />
          ...
          <div className='space-y-3'>
            {timeline.map((item) => (
              <div
                key={item.id}
                className='p-4 border rounded dark:bg-zinc-800 flex justify-between items-start'
              >
        ...
        <div>
              ...
              <div className='grid md:grid-cols-3 gap-4'>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSectionForm({ ...sectionForm, kind: e.target.value })
                    }
                    className='w-full px-4 py-2 border rounded dark:bg-zinc-700'
                  >
          ...
          <div className='space-y-3'>
            {sections.map((section) => (
              <div
                key={section.id}
                className='p-4 border rounded dark:bg-zinc-800'
              >
                <div className='flex justify-between items-start mb-2'>
                  <div className='flex-1'>
                    ...
                    <div className='text-xs text-zinc-500 mt-1'>
                      Kind: {section.kind} | Order: {section.sort_order}
                    </div>
                    {!section.is_visible && (
                      <span className='text-xs bg-zinc-200 dark:bg-zinc-700 px-2 py-1 rounded'>
                        Hidden
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      ...
                      <div className='text-xs text-zinc-500'>
                        {highlight.group_key} | Order: {highlight.sort_order}
                      </div>
            ...
            <div className='space-y-3'>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setQuoteForm({ ...quoteForm, caption: e.target.value })
                  }
                  className='w-full px-4 py-2 border rounded dark:bg-zinc-700'
                />
              </div>
              <div className='grid md:grid-cols-3 gap-4'>
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setQuoteForm({ ...quoteForm, theme: e.target.value })
                    }
                    className='w-full px-4 py-2 border rounded dark:bg-zinc-700'
                  >
              ...
              >
                <div className='flex justify-between items-start'>
                  <div className='flex-1'>
                    ...
                    {quote.caption && (
                      <p className='text-sm text-zinc-500'>— {quote.caption}</p>
                    )}
                    <div className='text-xs text-zinc-500 mt-2'>
                      Theme: {quote.theme} | Order: {quote.sort_order}
                      {!quote.is_visible && (
                        <span className='ml-2 bg-zinc-200 dark:bg-zinc-700 px-2 py-1 rounded'>
                          Hidden
                        </span>
                      )}
                    </div>
