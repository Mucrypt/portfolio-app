  ...
  const editProduct = (product: ShopProduct) => {
    ...
    setFormData({
      ...
      specifications: product.specifications
        ...
        : "",
      tech_stack: Array.isArray(product.tech_stack) ? product.tech_stack.join("\n") : product.tech_stack || "",
      ...
      included_items: Array.isArray(product.included_items) ? product.included_items.join("\n") : product.included_items || "",
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label className="block mb-2 font-medium">
                Affiliate Link{" "}
                <span className="text-red-500 font-bold">(MOST IMPORTANT!)</span>
              </label>
              <input
                type="text"
              ...
              <p className="text-xs text-gray-600 mt-1">
                Your revenue source! Amazon, Udemy, or other affiliate tracking URL
              </p>
            </div>

            <div>
              <label className="block mb-2 font-medium">External Product URL</label>
              <input
                type="text"
            ...
            <div>
              <label className="block mb-2 font-medium">Documentation URL</label>
              <input
                type="text"
                ...
                <div className="flex items-center gap-4">
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, is_in_stock: e.target.checked })
                      }
                      className="w-4 h-4"
                    />
                    <span>In Stock</span>
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mt-2">
                            ...
                            {product.purchases_count} purchases
                          </p>
                        </div>
