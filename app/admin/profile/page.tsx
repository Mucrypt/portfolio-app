  ...
  async function fetchProfile() {
    try {
      ...
      if (data) {
        ...
        // Type assertion for socials to access properties
        const socialsData = data.socials as Record<string, string> | null
        ...
        setFormData({
          ...
          phone: data.phone || '',
          bio: data.bio || '',
          role_tags: Array.isArray(data.role_tags)
            ? data.role_tags.join(', ')
            : '',
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, role_tags: e.target.value })
              }
              className='w-full px-3 py-2 border rounded-lg dark:bg-zinc-700'
