...
# Note: Comment out these provider blocks for the initial terraform init/apply
# Uncomment after EKS cluster is created to deploy k8s add-ons
provider "kubernetes" {
...
# Note: Comment out this module for the initial apply (since it requires the providers above)
# Uncomment after EKS cluster is created and providers are configured
module "k8s_addons" {
